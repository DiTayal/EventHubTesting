...
namespace DaaSEventListener.Infra.Messages {
    public sealed class MessageListener {
        ...
        public MessageListener(string storageconn, string blobname,string connectionString,string eventHubName)             
        {
            ...
            consumerEventHubsConnectionString = connectionString;
            consumerEventHubName = eventHubName;
            consumerGroup = "$Deafult";
            consumerWakeUpPeriod = 120;
        ...
        private async Task ProcessEventHandler(ProcessEventArgs args) {
            try {
                ...
                //consumeMessage(args.Data.EventBody);
